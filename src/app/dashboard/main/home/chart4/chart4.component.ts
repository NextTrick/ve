...
@Component({
  selector: 'home-chart4',
  templateUrl: './chart4.component.html',
  styleUrls: ['./chart4.component.css']
})
export class Chart4Component extends GoogleChartComponent implements OnInit {
    private options;
    private data;
    private chart;
    ...
    drawGraph() {
        ...
        this.chart = this.createBarChart(document.getElementById('chart4'));
